        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                ...
                <a href="activerUtilisateur.php?idUser=<?php echo $user['iduser'] ?>&etat=<?php echo $user['etat']  ?>">  
                                                <?php  
                                                    if($user['etat']==1)
                                                        echo '<span class="glyphicon glyphicon-remove">Activer/Desactiver</span>';
                                                        
                                                    else 
                                                        echo '<span class="glyphicon glyphicon-ok">Activer/Desactiver</span>';
